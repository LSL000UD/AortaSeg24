...
def idx_to_physical(image_nii, idx):
    return image_nii.TransformIndexToPhysicalPoint(idx)


def physical_to_idx(image_nii, physical):
    return image_nii.TransformPhysicalPointToIndex(physical)

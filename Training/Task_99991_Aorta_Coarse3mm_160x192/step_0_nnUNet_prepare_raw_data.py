...
from Utils.bbox import get_CT_non_air_bbox
...
def get_dataset():
    ...
    for case_id in list_train_case_ids:
        ...
        gt_nii = utils_simpleitk.copy_nii_info(image_nii, gt_nii)
        ...
        image_nii = utils_simpleitk.resample(image_nii, new_spacing=new_spacing[::-1], new_size=new_size[::-1], interp=sitk.sitkLinear)
        gt_nii = utils_simpleitk.resample_to_template(gt_nii, template_nii=image_nii, dtype=sitk.sitkUInt8, constant_value=0)
